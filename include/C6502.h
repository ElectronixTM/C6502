 ...
 * эмулятор будет всегда первым параметром передавать то, что ему будет возвращено из функции
 */
typedef void* M6502_BUS_HANDLE;

/**
 * Функция, присоединяющая устройство к шине. возвращенный указатель будет
 * всегда передаваться в качестве первого параметра во всех колбэках
 */
